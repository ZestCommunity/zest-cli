...
pub enum CliError {
    #[error(transparent)]
    #[diagnostic(code(zest_cli::io_error))]
    IoError(#[from] std::io::Error),

    #[error(transparent)]
    #[diagnostic(code(zest_cli::serial_error))]
    SerialError(#[from] vex_v5_serial::connection::serial::SerialError),

    #[error(transparent)]
    #[diagnostic(code(zest_cli::cdc2_nack))]
    Nack(#[from] Cdc2Ack),

    #[cfg(feature = "fetch-template")]
    #[error(transparent)]
    #[diagnostic(code(zest_cli::bad_response))]
    ReqwestError(#[from] reqwest::Error),

    #[cfg(feature = "fetch-template")]
    #[error("Recieved a malformed HTTP response")]
    #[diagnostic(code(zest_cli::malformed_response))]
    MalformedResponse,

    #[error(transparent)]
    #[diagnostic(code(zest_cli::image_error))]
    ImageError(#[from] ImageError),

    // TODO: Add source spans.
    #[error("Incorrect type for field `{field}` (expected {expected}, found {found}).")]
    #[diagnostic(
        code(zest_cli::bad_field_type),
    ...
    #[diagnostic(
        code(zest_cli::slot_out_of_range),
    ...
    #[diagnostic(code(zest_cli::elf_parse_error))]
    ...
    #[diagnostic(
        code(zest_cli::brain_connection_set_match_mode),
    ...
    #[diagnostic(
        code(zest_cli::project_dir_full),
